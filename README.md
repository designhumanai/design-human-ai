...
4. Откройте [DHAIE Concept v3.0-β](docs/DHAIE-Concept-v3.md) для формальных определений
...
2. [DHAIE Concept v3.0-β](docs/DHAIE-Concept-v3.md) — Операциональные определения
3. [Этические принципы](docs/ethics.md)
4. [Глоссарий терминов](docs/dhaie_philosophy.md#glossary)
