...
3. [Roadmap](docs/roadmap.md) — понять текущую фазу
4. [Neurostiv Framework](https://github.com/designhumanai/neurostiv-framework) — посмотреть код
5. Применить принципы в своем проекте
6. Поделиться результатами через [GitHub Issues](https://github.com/designhumanai/design-human-ai/issues)
